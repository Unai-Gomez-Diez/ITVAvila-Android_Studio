package src.com.iesam.itvavila.presentation;

import src.com.iesam.itvavila.domain.models.Camion;
import src.com.iesam.itvavila.domain.models.Coche;
import src.com.iesam.itvavila.domain.models.Inspeccion;
import src.com.iesam.itvavila.domain.models.Propietario;
import src.com.iesam.itvavila.domain.usecase.GuardarInspeccionUsaCase;
import src.com.iesam.itvavila.domain.usecase.GuardarPropietarioUseCasse;
import src.com.iesam.itvavila.domain.usecase.GuardarVehiculoUseCase;
import src.com.iesam.itvavila.domain.usecase.ObtenerInspeccionUseCase;
import src.com.iesam.itvavila.domain.usecase.ObtenerPropietarioUseCase;
import src.com.iesam.itvavila.domain.usecase.ObtenerVehiculoUseCase;
...
public class MainNota {
    public static void main(String[] args) {
        ...
        GuardarPropietarioUseCasse guardarPropietarioUseCase = new GuardarPropietarioUseCasse();
        ...
        GuardarInspeccionUsaCase guardarInspeccionUseCase = new GuardarInspeccionUsaCase();
